            ...
            btn.addEventListener("click", () => {
              ...
              showConfirmationDiv.innerHTML = `
                ...
                <div class='container-confirmationBts'>
                  <button id='buttonYes' data-id='${doc[1].id}' class='buttonYes'> S\xED </button> <button id='buttonNo' class='buttonNo'> No </button>
                </div>`;
              ...
              const btnsDelete2 = document.getElementById("buttonYes");
              btnsDelete2.addEventListener("click", ({ target: { dataset } }) => {
...
const editProfile = () => {
  ...
  imgBottom.className = "img-bottom-2";
  containerRegister.className = "container-register";
  p2.textContent = "Editar Nombre de Usuario:";
  p2.className = "text-subtitle2";
  avatar.src = user ? user.photoURL : "./lib/img/avatar-1.png";
  avatar.referrerPolicy = "no-referrer";
  avatar.className = "avatar-class";
  fondoImagen.className = "avatar-class";
  p22.textContent = "Editar Descripci\xF3n:";
  p22.className = "text-subtitle2";
  editName.type = "text";
  ...
  saveChanges.addEventListener("click", (e) => {
    ...
    if (editName.value === "" || editDescription.value === "") {
      alert("Falta completar tu informaci\xF3n");
