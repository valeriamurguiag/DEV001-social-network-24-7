...
const styleLandingPageLaptop = "";
const styleContact = "";
const styleAboutTheApp = "";
const categories = "";
const home = () => {
  ...
  description.textContent = '"24/7 es una red social para todas las mujeres en Latinoam\xE9rica. Una herramienta en donde pueden encontrar recursos sobre seguridad, apoyo emocional y salud sexual. Una red de apoyo que est\xE1 para nosotras 24/7"';
...
const db = La(app);
const functionRegister = async (email, password, name2, image2) => {
  try {
    ...
    if (error.code === "auth/email-already-in-use") {
      return "El correo ya est\xE1 registrado";
    }
    if (error.code === "auth/invalid-email") {
      return "Debes ingresar un correo v\xE1lido";
    }
    if (error.code === "auth/weak-password") {
      return "La contrase\xF1a debe tener al menos 6 car\xE1cteres";
    }
    return "Algo est\xE1 mal en tu registro";
  }
};
const functionLogin = async (email, password) => {
  try {
    ...
    if (error.code === "auth/user-not-found") {
      alert("Direcci\xF3n Email no encontrada, por favor reg\xEDstrese");
      return "error";
    }
    if (error.code) {
      alert("Error en inicio de sesi\xF3n, intente nuevamente");
      return "error";
    }
    return "error";
  }
};
const functionRegisterGoogle = async () => {
...
const functionSaveTask = (editdescription, nameUser, idUser, creationDate, likes, category) => {
  pl(ea(db, "task"), {
    editdescription,
    nameUser,
    idUser,
...
const functionOnGetTask = (callback) => Il(ea(db, "task"), callback);
const functionSignOut = async (authentication) => signOut(authentication);
const functionDeleteTask = (id2) => yl(sa(db, "task", id2));
const functionGetTask2 = (id2) => al(sa(db, "task", id2));
const functionUpdateTask = (id2, newTask) => gl(sa(db, "task", id2), newTask);
let image;
...
const register = () => {
  ...
  p2.textContent = "Nombre completo";
  ...
  p22.textContent = "Correo electr\xF3nico";
  p22.className = "text-subtitle";
  inputEmail.type = "email";
  inputEmail.id = "inputEmail";
  inputEmail.className = "input-register";
  inputEmail.required = "true";
  inputEmail.placeholder = "Ingresa tu email:";
  p3.textContent = "Contrase\xF1a";
  ...
  regresar.innerHTML = '\xBFYa tienes cuenta? <a href=""> Iniciar sesi\xF3n </a>';
  ...
  buttonSend.addEventListener("click", async () => {
    ...
    const result = await functionRegister(email, password, name2, photo);
...
const login = () => {
  ...
  imgBottom.className = "img-bottom-2";
  containerRegister.className = "container-register";
  p2.textContent = "Correo electr\xF3nico";
  p2.className = "text-subtitle";
  inputEmail.type = "email";
  inputEmail.id = "inputEmail";
  inputEmail.className = "input-register";
  ...
  inputPassword.required = "true";
  inputPassword.placeholder = "Ingresa tu contrase\xF1a:";
  regresar.innerHTML = '\xBFNo tienes cuenta? <a href=""> Reg\xEDstrate </a>';
  regresar.className = "link-login";
  buttonGoogle.innerHTML = '<img class="img-google" src="https://icones.pro/wp-content/uploads/2021/02/google-icone-symbole-logo-png-150x150.png" /> Iniciar Sesi\xF3n con Google';
  buttonGoogle.className = "button-google";
  buttonInicio.textContent = "Iniciar Sesi\xF3n";
...
const profile = () => {
  ...
  if (auth2.currentUser !== null) {
    localStorage.setItem("user", JSON.stringify(auth2.currentUser));
  }
...
let counter = 0;
const carousel = (iconRigth, iconLeft, arrayClassSlider) => {
...
const landingPage = () => {
  ...
  titleSelect.textContent = "Selecciona una categor\xEDa:";
  titleSelect.className = "title-categor\xEDa";
  ...
  iconMenu.addEventListener("click", () => {
    ...
    const options = `<nav class='menu-nav'>
      ...
      <li><a class='option' id='option2'>Cont\xE1ctanos</a></li>
        ...
        btn.addEventListener("click", ({ target: { dataset } }) => {
          ...
          showConfirmationDiv.innerHTML = `
              ...
              <div class='container-confirmationBts'>
                <button id='buttonYes' class='buttonYes'> S\xED </button> <button id='buttonNo' class='buttonNo'> No </button>
              </div>`;
            ...
            if (doc !== void 0) {
              try {
                if (!task.likes.includes(user.uid)) {
                  ...
                  const filterUsers = task.likes.filter((el2) => el2 !== user.uid);
                  functionUpdateTask(id, {
                    likes: filterUsers
                  });
                }
...
const contact = () => {
  ...
  const gabrielaMail = document.createElement("a");
  const imgGabrielaMail = document.createElement("img");
  ...
  gabrielaMail.href = "mailto:ruth.gabriela.pz@gmail.com";
  gabrielaMail.target = "_blank";
  imgGabrielaMail.className = "class-mail";
  imgGabrielaMail.src = "https://res.cloudinary.com/dfio49epx/image/upload/v1670978490/imagenes-24-7-repositorio/contact-mail_rvgpog.png";
  imgGabrielaMail.id = "gabriela-mail";
  ...
  silviaName.textContent = "Silvia Falc\xF3n";
  ...
  valeriaName.textContent = "Valeria Murgu\xEDa";
  ...
  gabrielaMail.appendChild(imgGabrielaMail);
...
const aboutTheApp = () => {
  ...
  description.textContent = '"24/7 es una red social para todas las mujeres en Latinoam\xE9rica. Una herramiento en la que pueden  encontrar recursos sobre seguridad, salud, apoyo emocional, y mucho m\xE1s. Una red de apoyo que estar\xE1 ah\xED para nosotras, 24/7."';
  description.className = "text-description";
  description2.textContent = '"Creado por mujeres, para mujeres. \u{1F90D}"';
  ...
  <br>
  <p> 2. No vender art\xEDculos ni servicios, ni pedir que se te los vendan a ti. </p>
  <br>
  <p> 3. No compartir anuncios ni publicidad ajena a la tem\xE1tica de la app. </p>
  <br>
  <p> 4. No difundir noticias falsas, investigar las fuentes. </p>
  <br>
  <p> 5. Los videos y/o links sin contexto no est\xE1n permitidos. </p>
  `;
